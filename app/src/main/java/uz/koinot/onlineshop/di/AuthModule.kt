package uz.koinot.onlineshop.di
...
import uz.koinot.onlineshop.utils.CONSTANTS
...
class AuthModule {
    ...
    @Provides
    @Singleton
    fun getAuthService(retrofit: Retrofit.Builder): AuthService = retrofit.build().create(AuthService::class.java)
